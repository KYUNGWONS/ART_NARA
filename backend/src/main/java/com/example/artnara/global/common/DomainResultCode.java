...
public enum DomainResultCode implements ResultCode {
    ...
    BID_OWN_ARTWORK("BID_403_OWN", "본인이 등록한 작품에는 입찰할 수 없습니다.", HttpStatus.FORBIDDEN),
    ...
    ORDER_OWN_ARTWORK("ORDER_403_OWN", "본인이 등록한 작품은 예약할 수 없습니다.", HttpStatus.FORBIDDEN),
    ...
    ORDER_ALREADY_RESERVED("ORDER_409_RESERVED", "이미 예약된 작품입니다.", HttpStatus.CONFLICT),
    ORDER_NOT_PARTICIPANT("ORDER_403_PARTICIPANT", "이 거래의 당사자만 할 수 있습니다.",
            HttpStatus.FORBIDDEN),
    ORDER_HANDOVER_REQUIRED("ORDER_400_HANDOVER",
            "판매자와 구매자가 모두 수령을 확인해야 결제할 수 있습니다.", HttpStatus.BAD_REQUEST),
    ORDER_ALREADY_PAID("ORDER_409_PAID", "이미 결제가 끝난 주문입니다.", HttpStatus.CONFLICT),
    ORDER_CANCELLED("ORDER_400_CANCELLED", "취소된 예약입니다.", HttpStatus.BAD_REQUEST),
    ORDER_BUYER_ONLY("ORDER_403_BUYER", "구매자만 결제할 수 있습니다.", HttpStatus.FORBIDDEN),
