              ...
              child: FilledButton.icon(
                ...
                style: FilledButton.styleFrom(
                  ...
                  padding: const EdgeInsets.symmetric(
                      horizontal: ArtSpacing.md, vertical: 10),
      ...
      child: Column(
        ...
        children: [
          Container(
            ...
            margin: const EdgeInsets.fromLTRB(ArtSpacing.lg, ArtSpacing.xs,
            ...
            child: _loading
                ...
                ? const Center(
                    child: Text('주변에 등록된 작품이 없어요',
                        style: ArtText.caption))
                : ListView.separated(
                    padding: const EdgeInsets.fromLTRB(ArtSpacing.lg, 0,
                        ArtSpacing.lg, ArtSpacing.lg),
